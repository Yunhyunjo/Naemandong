...
public class Rabbit40 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rScene99 rscene99 = new rScene99();
        transaction.replace(R.id.frame, rscene99);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Rabbit40.this, Setting.class);
