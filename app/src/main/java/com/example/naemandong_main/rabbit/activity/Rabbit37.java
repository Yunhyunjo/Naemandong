...
public class Rabbit37 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rScene93 rscene93 = new rScene93();
        transaction.replace(R.id.frame, rscene93);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Rabbit37.this, Setting.class);
