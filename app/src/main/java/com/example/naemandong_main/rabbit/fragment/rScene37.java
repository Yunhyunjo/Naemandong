...
public class rScene37 extends Fragment {
    ...
    private String subs [] = {"“아 맞다 경주 중이었지!! 너무 오래 잠들었잖아?”","깜짝 놀라 잠에서 깬 토끼는 깨워준 거북이를 못보고 달려갔어요.", "“ㅌ..토끼야….!”"};
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            mp1.setDataSource("http://49.50.174.179:9000/voice/rScene37_1.MP3");
            mp1.prepare();
            mp2.setDataSource("http://49.50.174.179:9000/voice/rScene37_2.mp3");
            mp2.prepare();
            mp3.setDataSource("http://49.50.174.179:9000/voice/rScene37_3.MP3");
            mp3.prepare();
        } catch (IOException e) {
            e.printStackTrace();
        }
