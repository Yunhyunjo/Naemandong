...
import com.example.naemandong_main.rabbit.fragment.rScene86;

import java.util.ArrayList;

public class Rabbit34 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rScene86 rscene86 = new rScene86();
        transaction.replace(R.id.frame, rscene86);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Rabbit34.this, Setting.class);
