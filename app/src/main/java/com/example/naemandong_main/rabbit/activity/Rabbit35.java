...
import com.example.naemandong_main.rabbit.fragment.rScene88;

public class Rabbit35 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rScene88 rscene88 = new rScene88();
        transaction.replace(R.id.frame, rscene88);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Rabbit35.this, Setting.class);
