...
import com.example.naemandong_main.rabbit.fragment.rScene55;

import java.util.ArrayList;

public class Rabbit21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rScene55 rscene55 = new rScene55();
        transaction.replace(R.id.frame, rscene55);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Rabbit21.this, Setting.class);
