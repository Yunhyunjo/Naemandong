...
import com.example.naemandong_main.rabbit.fragment.rScene50;

public class Rabbit19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rScene50 rscene50 = new rScene50();
        transaction.replace(R.id.frame, rscene50);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Rabbit19.this, Setting.class);
