...
import com.example.naemandong_main.rabbit.fragment.rScene34;

public class Rabbit11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rabbit11);
        ...
        rScene34 rscene34 = new rScene34();
        transaction.replace(R.id.frame, rscene34);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Rabbit11.this, Setting.class);
