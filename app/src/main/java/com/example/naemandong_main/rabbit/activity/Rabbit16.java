...
import com.example.naemandong_main.rabbit.fragment.rScene44;

import java.util.ArrayList;

public class Rabbit16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rScene44 rscene44 = new rScene44();
        transaction.replace(R.id.frame, rscene44);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Rabbit16.this, Setting.class);
