...
public class rScene72 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.rscene72, container, false);
        ...
        Glide.with(this)
                ...
                .into(background);
        Glide.with(this)
                .load("http://49.50.174.179:9000/images/rabbit/7/84_car.png")
                .into(bone);
        Glide.with(this)
                .load("http://49.50.174.179:9000/images/rabbit/7/84_bike.png")
                .into(fish);

        try {
            mp1.setDataSource("http://49.50.174.179:9000/voice/rScene72.mp3");
            mp1.prepare();
            mp1.start();
        } catch (IOException e) {
            e.printStackTrace();
        ...
        fish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((Rabbit27) getActivity()).setMylist(0);
        ...
        bone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((Rabbit27) getActivity()).setMylist(1);
