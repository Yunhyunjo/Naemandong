...
import com.example.naemandong_main.rabbit.fragment.rScene85;

import java.util.ArrayList;

public class Rabbit33 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rScene85 rscene85 = new rScene85();
        transaction.replace(R.id.frame, rscene85);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Rabbit33.this, Setting.class);
