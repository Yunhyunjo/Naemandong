...
import com.example.naemandong_main.rabbit.fragment.rScene40;

public class Rabbit14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rScene40 rscene40 = new rScene40();
        transaction.replace(R.id.frame, rscene40);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Rabbit14.this, Setting.class);
