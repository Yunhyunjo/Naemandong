...
import com.example.naemandong_main.rabbit.fragment.rScene63;

import java.util.ArrayList;

public class Rabbit25 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rScene63 rscene63 = new rScene63();
        transaction.replace(R.id.frame, rscene63);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Rabbit25.this, Setting.class);
