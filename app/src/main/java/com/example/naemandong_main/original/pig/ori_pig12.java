...
import com.example.naemandong_main.pig.fragment.pScene65;

// 첫둘 돼지 막돼집으로 가기로함
public class ori_pig12 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        delayHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                ori_pig13 pig13 = new ori_pig13();
                transaction.replace(R.id.frame, pig13);
