...
public class Pig20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pScene62 pscene62 = new pScene62();
        transaction.replace(R.id.frame, pscene62);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Pig20.this, Setting.class);
