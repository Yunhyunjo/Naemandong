...
// 첫둘 돼지 막돼집으로 가기로함
public class pScene119 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Glide.with(this)
                .load("http://49.50.174.179:9000/images/pig/1/20_pig2-01.png")
                .into(pigs);

        try {
            mp1.setDataSource("http://49.50.174.179:9000/voice/pig/pScene50_2.mp3");
            mp1.prepare();
            mp2.setDataSource("http://49.50.174.179:9000/voice/pig/pScene50_3.mp3");
            mp2.prepare();
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pScene120 pscene120 = new pScene120();
                transaction.replace(R.id.frame,pscene120);
