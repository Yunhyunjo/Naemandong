...
import com.example.naemandong_main.pig.fragment.pScene105;
import com.example.naemandong_main.pig.fragment.pScene99;

import java.util.ArrayList;

public class Pig32 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pScene105 pscene105 = new pScene105();
        transaction.replace(R.id.frame, pscene105);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Pig32.this, Setting.class);
