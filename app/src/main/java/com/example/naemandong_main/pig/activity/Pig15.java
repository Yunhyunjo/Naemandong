...
import com.example.naemandong_main.pig.fragment.pScene29;
import com.example.naemandong_main.pig.fragment.pScene48;

public class Pig15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pScene48 pscene48 = new pScene48();
        transaction.replace(R.id.frame, pscene48);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Pig15.this, Setting.class);
