...
public class pScene123 extends Fragment {
    ...
    private View view;
    private ImageView background, pig1, box;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Glide.with(this)
                .load("http://49.50.174.179:9000/images/pig/1/10_bg-02.png")
                .into(background);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pScene124 pscene124 = new pScene124();
                transaction.replace(R.id.frame,pscene124);
