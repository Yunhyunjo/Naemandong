...
public class Pig11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pScene40 pscene40 = new pScene40();
        transaction.replace(R.id.frame, pscene40);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Pig11.this, Setting.class);
