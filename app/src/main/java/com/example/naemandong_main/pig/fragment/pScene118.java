...
// 첫둘 돼지 막돼집으로 가기로함
public class pScene118 extends Fragment {
    ...
    private View view;
    private ImageView background, pigs, pig, house, house_inside, box;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.pscene118, container,false);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pScene119 pscene119 = new pScene119();
                transaction.replace(R.id.frame,pscene119);
