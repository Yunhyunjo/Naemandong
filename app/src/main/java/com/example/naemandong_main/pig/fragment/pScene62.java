...
public class pScene62 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            mp1.setDataSource("http://49.50.174.179:9000/voice/pig/pScene76_1.mp3");
            mp1.prepare();
            mp2.setDataSource("http://49.50.174.179:9000/voice/pig/pScene62_2.mp3");
            mp2.prepare();
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pScene63 pscene63 = new pScene63();
                transaction.replace(R.id.frame,pscene63);
