...
import com.example.naemandong_main.pig.fragment.pScene42;

import java.util.ArrayList;

public class Pig12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pScene42 pscene42 = new pScene42();
        transaction.replace(R.id.frame, pscene42);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Pig12.this, Setting.class);
