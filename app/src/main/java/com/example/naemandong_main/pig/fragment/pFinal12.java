...
public class pFinal12 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            mp1.setDataSource("http://49.50.174.179:9000/voice/pig/pFinal12_1.mp3");
            mp1.prepare();
            mp2.setDataSource("http://49.50.174.179:9000/voice/pig/pFinal12_2.mp3");
            mp2.prepare();
        } catch (IOException e) {
            e.printStackTrace();
        }
            ...
            public void onClick(View v) {
                if (((Setting_data) getContext().getApplicationContext()).isRecord()) {
                    ...
                    while (recordList.size() < 30)
                        recordList.add("0");
                    saveDialog = new Save_Dialog(getActivity(), book_no, "아기돼지 삼형제", 2, recordList, "http://49.50.174.179:9000/images/cover/pig/1-01.png", true);
                    saveDialog.show();
