...
public class pScene101 extends Fragment {
    ...
    private String subs [] = {"마침내 막내돼지는 밧줄 풀기에 성공했어요.", "도망치려던 막내돼지는 쿨쿨 자고 있는 늑대의 배를 가르기로 했어요.", "“저 나쁜 늑대의 배를 갈라야겠다”"};
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            mp1.setDataSource("http://49.50.174.179:9000/voice/pig/pScene101_1.mp3");
            mp1.prepare();
            mp2.setDataSource("http://49.50.174.179:9000/voice/pig/pScene101_2.mp3");
            mp2.prepare();
            mp3.setDataSource("http://49.50.174.179:9000/voice/pig/pScene101_3.mp3");
            mp3.prepare();
        } catch (IOException e) {
            e.printStackTrace();
        }
