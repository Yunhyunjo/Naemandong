...
import com.example.naemandong_main.pig.fragment.pFinal05;
...
public class pScene43 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            mp1.setDataSource("http://49.50.174.179:9000/voice/pig/pScene43_1.mp3");
            mp1.prepare();
            mp2.setDataSource("http://49.50.174.179:9000/voice/pig/pScene43_2.mp3");
            mp2.prepare();
        } catch (IOException e) {
            e.printStackTrace();
        }
