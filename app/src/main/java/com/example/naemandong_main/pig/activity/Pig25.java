...
public class Pig25 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pScene76 pscene76 = new pScene76();
        transaction.replace(R.id.frame, pscene76);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Pig25.this, Setting.class);
