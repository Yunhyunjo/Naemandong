...
public class Pig16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pScene53 pscene53 = new pScene53();
        transaction.replace(R.id.frame, pscene53);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Pig16.this, Setting.class);
