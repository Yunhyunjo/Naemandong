...
public class Pig19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pScene60 pscene60 = new pScene60();
        transaction.replace(R.id.frame, pscene60);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Pig19.this, Setting.class);
