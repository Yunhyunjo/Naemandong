...
import com.example.naemandong_main.pig.fragment.pScene15;

import java.util.ArrayList;

public class Pig04 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pScene15 pscene15 = new pScene15();
        transaction.replace(R.id.frame, pscene15);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Pig04.this, Setting.class);
