...
import com.example.naemandong_main.pig.fragment.pScene08;

public class Pig03 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pScene08 pscene08 = new pScene08();
        transaction.replace(R.id.frame, pscene08);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Pig03.this, Setting.class);
