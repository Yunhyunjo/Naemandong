...
public class pScene100 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            mp1.setDataSource("http://49.50.174.179:9000/voice/pig/pScene100_1.mp3");
            mp1.prepare();
            mp2.setDataSource("http://49.50.174.179:9000/voice/pig/pScene100_2.mp3");
            mp2.prepare();
            mp3.setDataSource("http://49.50.174.179:9000/voice/pig/pScene100_3.mp3");
            mp3.prepare();
        } catch (IOException e) {
            e.printStackTrace();
        }
