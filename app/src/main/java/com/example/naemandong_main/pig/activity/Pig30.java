...
import com.example.naemandong_main.pig.fragment.pScene91;

public class Pig30 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pScene91 pscene91 = new pScene91();
        transaction.replace(R.id.frame, pscene91);
        pscene91.setArguments(bundle);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Pig30.this, Setting.class);
