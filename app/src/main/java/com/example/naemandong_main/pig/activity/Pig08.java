...
public class Pig08 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pScene29 pscene29 = new pScene29();
        transaction.replace(R.id.frame, pscene29);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Pig08.this, Setting.class);
