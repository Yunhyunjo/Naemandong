...
import com.example.naemandong_main.pig.fragment.pScene46;
import com.example.naemandong_main.pig.fragment.pScene47;

public class Pig14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pScene46 pscene46 = new pScene46();
        transaction.replace(R.id.frame, pscene46);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Pig14.this, Setting.class);
