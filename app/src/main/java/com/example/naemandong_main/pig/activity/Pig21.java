...
import com.example.naemandong_main.pig.fragment.pScene53;
import com.example.naemandong_main.pig.fragment.pScene67;

public class Pig21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pScene67 pscene67 = new pScene67();
        transaction.replace(R.id.frame, pscene67);
        transaction.commit();  //저장

        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Pig21.this, Setting.class);
